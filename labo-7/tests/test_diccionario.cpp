...
TEST(diccionario, dicc_string_bool) {
    ...
    ASSERT_FALSE(d.def("hola Mundo"));
    ASSERT_FALSE(d.def("chau"));
    ASSERT_FALSE(d.def("biEn"));
    d.definir("hola Mundo", true);
    ASSERT_TRUE(d.def("hola Mundo"));
    ASSERT_FALSE(d.def("chau"));
    ASSERT_FALSE(d.def("biEn"));
    ASSERT_EQ(d.obtener("hola Mundo"), true);
    ...
    d.definir("hola Mundo", false);
    ASSERT_TRUE(d.def("hola Mundo"));
    ASSERT_TRUE(d.def("chau"));
    ASSERT_FALSE(d.def("biEn"));
    ASSERT_EQ(d.obtener("hola Mundo"), false);
    ASSERT_EQ(d.obtener("chau"), false);
}
